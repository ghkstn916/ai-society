...
export default function Lesson2_3() {
  ...
  return (
    <article className="space-y-8">
      ...
      {/* 직업 방향 시나리오 퀴즈 */}
      <ChoiceQuiz
        question="소아과 의사가 AI 진단 보조 시스템을 활용해 환자 차트를 빠르게 분석한다면, AI 시대 세 가지 방향 중 어디에 해당할까요?"
        options={[
          'AI 알고리즘을 연구하고 딥러닝 모델을 직접 개발한다',
          '세 가지 방향 모두에 해당한다',
          'AI 기반 새로운 의료 서비스를 기획·창업한다',
          '기존 직업을 유지하면서 AI 도구를 업무에 활용한다',
          '의사는 AI와 관계없는 직업이다',
        ]}
        answer={3}
        explanation="기존 직업(의사)을 유지하면서 AI 도구를 업무에 활용하는 것이 ③번 방향입니다. 가장 많은 사람에게 해당되는 변화로, 어떤 직업을 갖든 이 방향을 준비하는 것이 중요합니다."
